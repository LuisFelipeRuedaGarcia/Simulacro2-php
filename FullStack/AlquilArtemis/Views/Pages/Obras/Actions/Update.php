...
$Url2="http://localhost/Simulacro2-php/FullStack/ApiRest/Controllers/Obra.php?op=GetbyId";
$data2 = array("IdObra"=>$_GET["IdObra"]);
$Curl2 = curl_init();
...
/* echo "<pre>";
echo$Output2[0]->IdObra;
echo" </pre>----------------------------------------------------------------------------------------------------";*/

if(isset($_POST["Editar"])){
    $Url5="http://localhost/Simulacro2-php/FullStack/ApiRest/Controllers/Obra.php?op=Update";
    $data5 = array(
        "IdObra"=>$_POST["IdObra"],
...
<body>
    <form action="" method="POST">
        ...
        <input value="<?=$Output2[0]->Direccion?>" type="text"  name="Direccion" id="Direccion">
        <br>
